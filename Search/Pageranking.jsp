...
else
{
	...
	ResultSet rs=st.executeQuery("select location from PRA where about='"+searchword+"' order by counter desc");
	String location="";
	if(!rs.next())
	{
	...
	{
	 rs=st.executeQuery("select location from PRA where about='"+searchword+"' order by counter desc");
		while(rs.next())
		{
...
<table border="0" width="75%" cellspacing="5" cellpadding="5">
  <tr >
    	...
    	></tr>
		<tr width=""  >
      <td align='left' colspan="8" ><form name="form1" method="post" action="Pageranking.jsp?value=again">
	...
	<tr> <td align="center" > <a href="Pageranking.jsp?value=null" ><font color="#FF0000"> 1 </a> <a href="Pageremaining.jsp?value=redirect"><font color="#FF0000"> &nbsp;2 </a></td></tr>
	</table>
	</td>
	</tr>
</table>
